 ...
 * @author FallenDown
 */
public class Chart_Category extends JFrame{
    private int cc = 1;
    private JFXPanel fxPanel;
    private JButton b1;
    CategoryMenu obj = new CategoryMenu();
    ArrayList<Category> list = obj.getCategoryList();
    ...
    private void ShowChart() {
        ...
        if (cc % 2 == 0) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    series1.getData().add(new XYChart.Data(list.get(i).getName(), list.get(i).getCount()));
